...
const NAV_ITEMS = [
  {
    ...
    label: "Dashboard",
    icon: "bi-grid",
    href: `${BASE_PATH}/app/dashboard/dashboard.html`,
  },
  {
    id: "projects",
    label: "Projects",
    icon: "bi-folder2-open",
    href: `${BASE_PATH}/app/projects/projects.html`,
  },
  {
    id: "categories",
    label: "Categories",
    icon: "bi-tags",
    href: `${BASE_PATH}/app/categories/categories.html`,
  },
  {
    id: "statistics",
    label: "Statistics",
    icon: "bi-bar-chart",
    href: `${BASE_PATH}/app/statistics/statistics.html`,
  },
  {
    id: "search",
    label: "Search",
    icon: "bi-search",
    href: `${BASE_PATH}/app/search/search.html`,
  },
  {
    id: "profile",
    label: "Profile",
    icon: "bi-person-circle",
    href: `${BASE_PATH}/app/profile/profile.html`,
  },
];
...
class NavSidebar extends HTMLElement {
  connectedCallback() {
    ...
    const dashboardHref = `${BASE_PATH}/app/dashboard/dashboard.html`;
    ...
    this.innerHTML = `
      <nav class="navbar navbar-dark d-lg-none border-bottom sticky-top" style="background-color: var(--bs-tertiary-bg);">
        <div class="container-fluid">
          ...
          <a class="navbar-brand wordmark ms-2" href="${dashboardHref}">
      ...
      <div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="sidebarOffcanvas">
        <div class="offcanvas-header border-bottom">
          <a class="wordmark" href="${dashboardHref}"><span class="ember-dot"></span>Phoenix</a>
      ...
      <aside class="d-none d-lg-flex flex-column position-fixed top-0 start-0 bottom-0 border-end p-3"
        ...
        <a href="${dashboardHref}" class="wordmark mb-4"><span class="ember-dot"></span>Phoenix</a>
        <div class="list-group list-group-flush flex-grow-1">${links}</div>
